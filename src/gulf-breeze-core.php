...
final class Gulf_Breeze_Configuration {
	...
	private function __construct() {
		...
		add_action( 'admin_init', array( $this, 'run_verified_curriculum_migrations' ), 20 );
	...
	public function run_verified_curriculum_migrations() {
		...
		if(version_compare((string)get_option('gb_curriculum_migration_version',''),'1.6.0','<')){
		...
		if(version_compare((string)get_option('gb_curriculum_migration_version',''),'1.7.0','<')){
		$registry=get_option(self::COURSE_OPTION,array()); $course_id=absint($registry['adult_en']['learnpress_course_id']??0); global $wpdb;
		...
		if(version_compare((string)get_option('gb_curriculum_migration_version',''),'1.8.0','>='))return;
		$registry=get_option(self::COURSE_OPTION,array()); $course_id=absint($registry['adult_en']['learnpress_course_id']??0); global $wpdb;
