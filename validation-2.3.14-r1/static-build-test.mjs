...
const pluginDir = process.env.GB_PLUGIN_DIR || path.join(root, 'build-2.3.14-r1', 'gulf-breeze-core');
...
assert(/Version:\s*2\.3\.14-dev/.test(php), 'Plugin header is not 2.3.14-dev.');
assert(/GB_CORE_VERSION', '2\.3\.14-dev'/.test(php), 'Runtime version constant is not 2.3.14-dev.');
assert(readme.includes('Core 2.3.14'), 'README does not document Core 2.3.14.');
...
console.log('Static Core 2.3.14 revision 1 build checks passed.');
