...
$validation_dir = $workspace . '/validation-2.3.15-r1';
...
if ( '2.3.9' !== (string) get_option( 'gb_curriculum_migration_version', '' ) || 'success' !== ( $resume_status['status'] ?? '' ) ) {
...
echo "PASS Topic 4.1.7 boundary correction, sequential 2.3.3-2.3.9 resume, preservation, and idempotency\n";
