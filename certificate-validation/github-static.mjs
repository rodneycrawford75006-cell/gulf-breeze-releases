...
const required = [
  ["r2 version", "const VERSION = '0.1.0-dev-r2'"],
  ...
  ['download nonce', "check_admin_referer( 'gb_cert_download_'"],
  ['download ownership', "absint( $row['user_id'] ) !== get_current_user_id()"],
  ['administrator capability', "current_user_can( 'manage_options' )"],
