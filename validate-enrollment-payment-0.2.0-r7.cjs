...
const root = process.env.GB_EP_PLUGIN_DIR || path.resolve(__dirname, 'combined-r7', 'gulf-breeze-enrollment-payment');
...
const checks = [
  ['version r7', /Version:\s*0\.2\.0-dev-r7/.test(php) && /const VERSION = '0\.2\.0-dev-r7'/.test(php)],
  ...
  ['no stale development version', !/0\.2\.0-dev-r[1-6]/.test(php + readme)],
];
